...
TOOL_CAPABILITIES: dict[str, str] = {
    "shell_run": CAP_SHELL,
    "shell_exec": CAP_SHELL,
    "shell_view": CAP_SHELL,
    "shell_write": CAP_SHELL,
    "shell_kill": CAP_SHELL,
    "file_read": CAP_READ,
    ...
    "glob": CAP_READ,
    "grep": CAP_READ,
    "web_fetch": CAP_BROWSER,
    "web_search": CAP_BROWSER,
    "validate_project": CAP_READ,
    "document_render": CAP_WRITE_FILES,
